...
<qgis version="1.5.0-Tethys" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0" >
  ...
  <graduatedsymbol>
    ...
    <symbol>
      ...
      <uppervalue>1500</uppervalue>
      <label>0 - 1500 (tons/yr)</label>
    ...
    <symbol>
      ...
      <uppervalue>5000</uppervalue>
      <label>1500 - 5000 (tons/yr)</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>
    ...
    <symbol>
      ...
      <uppervalue>17500</uppervalue>
      <label>5000 - 17500 (tons/yr)</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>
    ...
    <symbol>
      <lowervalue>17500</lowervalue>
      <uppervalue>30000</uppervalue>
      <label>17500 - 30000 (tons/yr)</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>
    ...
    <symbol>
      <lowervalue>30000</lowervalue>
      <uppervalue>175000</uppervalue>
      <label>30000 - 175000 (tons/yr)</label>
      <pointsymbol>hard:circle</pointsymbol>
      <pointsize>2</pointsize>
      <pointsizeunits>pixels</pointsizeunits>
      <rotationclassificationfieldname></rotationclassificationfieldname>
